...
4. **Testing** — 317 unit tests covering roundtrip (65,536 RGB565 + 32,768 RGB555 values), fuzz (250 random inputs across 5 engines), SIMD identity (10 tests), YUV tolerance, EXIF parsing, and JSON profile loading.
