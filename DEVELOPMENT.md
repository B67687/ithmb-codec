...
2. **Format table extraction** — iOpenPod (50+ entries), libgpod, iLounge threads, and Keith's iPod Photo Reader provided dimension/encoding tables for 47 profiles (22 photo + 25 cover art).
...
4. **Testing** — 317 unit tests covering roundtrip (65,536 RGB565 + 32,768 RGB555 values), fuzz (250 random inputs across 5 engines), SIMD identity (18 tests), YUV tolerance, EXIF parsing, and JSON profile loading.
